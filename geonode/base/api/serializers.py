...
class ResourceBaseSerializer(
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['bbox_polygon'] = fields.GeometryField(required=False, read_only=True)
        self.fields['ll_bbox_polygon'] = fields.GeometryField(required=False, read_only=True)
